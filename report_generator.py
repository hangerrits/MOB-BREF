# /home/ubuntu/bat_rie_checker/core_logic/report_generator.py
...
def generate_markdown_report(permit_data: dict, applicable_brefs: list, compliance_results: list, report_id: str) -> str:
    ...
    Args:
        permit_data: Dictionary containing processed permit information.
        applicable_brefs: List of dictionaries detailing applicable BREFs and justifications.
        compliance_results: List of dictionaries detailing compliance status for each BAT.
...
def generate_pdf_report(markdown_content: str, report_id: str, output_filename: str) -> str | None:
    """
    ...
    # Using pre-installed Noto Sans CJK font for broader character support
    css_style = """
    @page {
        size: A4;
        margin: 2cm;
    ...
    code {
        font-family: "Noto Sans CJK SC", "WenQuanYi Zen Hei", monospace; 
    }
    """
...
if __name__ == '__main__':
    ...
    sample_report_id = "TEST_REPORT_001"
    sample_permit_data = {
    ...
    # First, ensure markdown2 is installed for the test to run
    try:
        import markdown2
    except ImportError:
        ...
        generated_pdf_path = generate_pdf_report(markdown_report_content, sample_report_id, pdf_output_filename)
